                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="img_box">
                                <figure><img src="product/b10.jpg" alt="#" /></figure>
                            </div>
                        </div>
            ...
            ?>
                     ...
                     <?php } ?>
                                ...
                                <div class="detail-contant">
                                    ...
                                    <form class="cart" method="post" action="add_cart8.php">
                                        <div class="quantity">
                                            <input step="1" min="1" name="qty" value="1" title="Qty" class="input-text qty text" size="4" type="number">
                                        </div>
                                        <button type="submit" class="bt_main" name="add"><a href="register.php">Add to cart</a></button>
                                    </form>
                                </div>
                            </div>
                        </div>
