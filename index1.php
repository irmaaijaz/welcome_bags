            ...
            <ul class="list-unstyled components">
                ...
                <li class="active"> <a href="index.php">Home</a></li>
                 <li> <a href="about.php">About</a></li>
                                        ...
                                        <li><a href="upload.php">Data Insertion</a></li>
                                        <li><a href="logoutt.php">log out</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-3 logo_section">
                                <div class="full">
                                    <div class="center-desk">
                                        <div class="logo">
                                            <a href="index.php"><img src="images/teal.png" alt="#"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <div class="right_header_info">
                                    <ul>
                                        <li>
                                            <a href="register.php"><img style="margin-right: 15px;" src="icon/1.png" alt="register.php" /></a>
                                            
                                        </li>
                                        <li>
                                            <a href="admin.php"><img style="margin-right: 15px;" src="icon/2.png" alt="admin.php" /></a>
