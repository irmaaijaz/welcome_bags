                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="img_box">
                                <figure><img src="product/b1.jpg" alt="#" /></figure>
                            </div>
                        </div>
            ...
            ?>
                     ...
                     <?php } ?>
                                ...
                                <div class="detail-contant">
                                    ...
                                    <form class="cart" method="post" action="add_cart5.php">
                                        <div class="quantity">
            ...
            <div class="layout_padding-2">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="img_box">
                                <figure><img src="product/b13.jpg" alt="#" /></figure>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 product_detail_side">
                            <div class="abotext_box">
                     ...
                     <i class="fa fa-star-o" aria-hidden="true"></i>
                                ...
                                <div class="detail-contant">
                                    ...
                                    <form class="cart" method="post" action="shop-cart.php">
                                        <div class="quantity">
